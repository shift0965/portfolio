...
const Projects = (props) => {
  ...
  return (
    <section id="projects" className=" container md:flex-row">
      <div className="head mb-3 md:absolute md:top-32 xl:top-48 text-tx-500 md:text-left xl:-left-8 md:left-0">
        <h2
          className={`${
            props.isActive
      ...
      <Swiper
        ...
        mySwiper md:left-1/2 xl:left-[60%] md:absolute 2xl:w-[420px] md:w-[300px] w-[240px] duration-700`}
      >
            ...
            <SwiperSlide key={index}>
              <div className=" w-full xl:py-[50px] md:py-[30px] py-[10px] px-5 grid grid-col-1 justify-center">
                ...
                <div className="data mt-4">
                  ...
                  <p className="mt-2.5 font-bold text-secondary">
                    {item.subtitle}
                  </p>
                  <p className="mt-1 text-light whitespace-pre-line">
                    {item.description}
                  </p>
                  <a
                    href={item.href}
                    className="  rounded-2xl py-1.5 px-7 inline-block mt-5 duration-300
